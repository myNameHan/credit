package com.atguigu.credit.bean;
...
public class NplmRepaymentPlan implements Serializable {
  ...
  @Column
  private Long indeedChange_fee;
  @Column
  private Long indeedOther_fee;
  @Column
  ...
  public Long getIndeedChange_fee() {
    return indeedChange_fee;
  }

  public void setIndeedChange_fee(Long indeedChange_fee) {
    this.indeedChange_fee = indeedChange_fee;
  }

  public Long getIndeedOther_fee() {
    return indeedOther_fee;
  }

  public void setIndeedOther_fee(Long indeedOther_fee) {
    this.indeedOther_fee = indeedOther_fee;
  }
  ...
  public Long getReduceInst_fee() {
    return reduceInst_fee;
  }

  public void setReduceInst_fee(Long reduceInst_fee) {
    this.reduceInst_fee = reduceInst_fee;
  }
