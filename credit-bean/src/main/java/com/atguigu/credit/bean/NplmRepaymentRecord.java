...
public class NplmRepaymentRecord implements Serializable {
  ...
  private Long id;
  @Column
  private Long businessRequest_id;
  @Column
  ...
  public Long getBusinessRequest_id() {
    return businessRequest_id;
  }

  public void setBusinessRequest_id(Long businessRequest_id) {
    this.businessRequest_id = businessRequest_id;
  }
